...
conf = grobase.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "http://127.0.0.1:8002" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("grobase")
        ...
        return [
            {
                ...
                'description': "Local Kong gateway (mini-baas-infra)",
            },
            {
                'url': "https://{host}",
                'description': "Deployed gateway",
                'variables': {
                    'host': {
                        'description': "No description provided",
                        'default_value': "api.grobase.dev",
                        }
                    }
            }
        ]
