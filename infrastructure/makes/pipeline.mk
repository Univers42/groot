...
all: sync-submodules-soft secrets-ensure certs certs-trust-local backend-up env-local-ensure restore-if-empty live-data-ensure mounts-reencrypt frontends-up healthcheck showcase
...
all-local: sync-submodules-soft secrets-ensure certs certs-trust-local backend-up env-local-ensure restore-if-empty live-data-ensure mounts-reencrypt frontends-up healthcheck showcase
